<?php
	...
	class ShopTableDao {
		...
		static $config = array(1 => array("image" => "images/pos_shop/Verwaltung.JPG", "color" => "#715B47"),
			array("image" => "images/pos_shop/Verteidigung1.jpg", "color" => "#E19D3B"),
			array("image" => "images/pos_shop/Ordnung1.jpg", "color" => "#419D53"),
			array("image" => "images/pos_shop/Landwirtschaft.jpg", "color" => "#547353"),
			array("image" => "images/pos_shop/Umwelt.jpg", "color" => "#0F9173"),
			array("image" => "images/pos_shop/Wohnungswesenn.jpg", "color" => "#008BBA"),
			array("image" => "images/pos_shop/Gesundheit1.jpg", "color" => "#4364A6"),
			array("image" => "images/pos_shop/Kultur.jpg", "color" => "#6D4F99"),
			array("image" => "images/pos_shop/Bildung.jpg", "color" => "#DD4F49"),
			array("image" => "images/pos_shop/Sozialsystem.jpg", "color" => "#E65D56"),
